...
class Mostrar_Comida : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mostrar_comida)


        itemsListView = findViewById(R.id.Comi)
        arrayListProducto= arrayListOf()


        adapter = CustomAdapter(this@Mostrar_Comida, arrayListProducto)
    ...
    private fun EventChangeListener(){
        ...
        db.collection("Producto").whereEqualTo("tipo_comida","Comida").addSnapshotListener(object : EventListener<QuerySnapshot>
        {
    ...
    private fun saveProductCar(list: ArrayList<ProductCar>) {
        ...
        editor.commit()
        Toast.makeText(this@Mostrar_Comida, "Producto Agregado al Carrito", Toast.LENGTH_SHORT).show()
    }
